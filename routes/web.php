...
Route::group(['prefix' => 'barang', 'middleware' => ['acc']], function () {
...
Route::group(['prefix' => 'stok', 'middleware' => ['admin']], function () {
...
Route::group(['prefix' => 'kategori', 'middleware' => ['acc']], function () {
...
Route::group(['prefix' => 'penjualan', 'middleware' => ['acc']], function () {
